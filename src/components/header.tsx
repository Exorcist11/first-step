...
export default function Header() {
  return (
    <div>
      <div className="hidden laptop:bg-[#061123] laptop:px-40 laptop:text-base text-xs text-white py-3 px-5  mx-auto laptop:flex flex-col laptop:flex-row justify-between items-center laptop:items-start gap-3">
